...
import 'package:book_a_bite_resto/controller/fcm_controller.dart';
import 'package:book_a_bite_resto/controller/general_controller.dart';
import 'package:book_a_bite_resto/modules/image_full_view/view.dart';
import 'package:book_a_bite_resto/utils/colors.dart';
import 'package:book_a_bite_resto/widgets/custom_dotted_divider.dart';
...
class _OrderDetailPageState extends State<OrderDetailPage> {
                          ...
                          children: [
                            Text('BYOC',
                                ...
                                style: GoogleFonts.nunito(
                                    ...
                                    color: customGreenColor)),
                            Text(
                                widget.orderModel!.get('go_green').toString() ==
                                        'true'
                                    ? 'Yes'
                                    : 'No',
                                textAlign: TextAlign.center,
                          ...
                          children: [
                            Text('BYOB',
                                ...
                                style: GoogleFonts.nunito(
                                    ...
                                    color: customGreenColor)),
                            Text(
                                widget.orderModel!.get('BOYB').toString() ==
                                        'true'
                                    ? 'Yes'
                                    : 'No',
                                textAlign: TextAlign.center,
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    '\$${widget.orderModel!.get('total_price')}',
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    '\$${widget.orderModel!.get('total_discount')}',
                    style: state.billValueTextStyle,
                  ),
                ],
              ),
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    '\$${(double.parse(widget.orderModel!.get('net_price').toString()) - commissionDiscount!).toPrecision(2)}',
                    style: state.grandTotalTextStyle,
                  ),
                ],
              ),
  ...
  TextEditingController biteCodeController = TextEditingController();
  biteCodeDialog(BuildContext context1) {
    biteCodeController.clear();
                                      ...
                                      if (_formKey.currentState!.validate()) {
                                        if (widget.orderModel!
                                          ...
                                          sendNotificationCall(
                                              queryForUser.docs[0].get('token'),
                                              '',
                                              'Your order is now successfully completed. Enjoy those tasty bites and take a minute to review this order to redeem ${widget.orderModel!.get('net_price')} Zero Hero Points');
                                          sendNotificationCall(
                                              queryForUser.docs[0].get('token'),
                                              '',
